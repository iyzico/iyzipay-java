...
import com.iyzipay.request.CreateConnectPaymentPostAuthRequest;
...
public class ConnectPaymentPostAuth extends IyzipayResource {
    ...
    public static ConnectPaymentPostAuth create(CreateConnectPaymentPostAuthRequest request, Options options) {
