...
public class ThreedsPreAuthSample extends Sample {
    ...
    @Test
    public void should_initialize_threeds_payment_for_standard_merchant() {
    ...
    @Test
    public void should_initialize_threeds_payment_for_market_place() {
        CreatePaymentRequest request = new CreatePaymentRequest();
        request.setLocale(Locale.TR.getValue());
        request.setConversationId("123456789");
        request.setPrice(new BigDecimal("1"));
    ...
    @Test
    public void should_initialize_threeds_payment_for_listing_or_subscription() {
        CreatePaymentRequest request = new CreatePaymentRequest();
        request.setLocale(Locale.TR.getValue());
        request.setConversationId("123456789");
        request.setPrice(new BigDecimal("1"));
    ...
    @Test
    public void should_retrieve_threeds_payment() {
